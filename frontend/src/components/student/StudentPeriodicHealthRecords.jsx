...
import studentService from "../../api/services/student.service" // Adjusted path

const StudentPeriodicHealthRecords = () => {
      ...
      <div className="bg-gradient-to-r from-blue-600 to-green-600 text-white rounded-xl shadow-lg p-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="text-2xl font-bold">Kết quả khám sức khỏe định kỳ</h2>
...
export default StudentPeriodicHealthRecords

...
import {
  ...
  Droplet,
  ShieldOff,
  Bug as Virus, // Thay WormIcon bằng Bug
  Pill,
  FileText,
  AlertCircle,
} from "lucide-react"
...
const StudentHealthProfile = ({ selectedStudent }) => {
      ...
      <div className="bg-gradient-to-r from-pink-500 to-purple-500 text-white rounded-xl shadow-lg p-6">
        <div className="flex items-center justify-between">
          ...
          {/* <div className="text-right">
            <div className="text-2xl font-bold">ID: {formatValue(healthProfile.studentId)}</div>
            <div className="text-sm text-pink-100">Mã học sinh</div>
          </div> */}
        </div>
      </div>
